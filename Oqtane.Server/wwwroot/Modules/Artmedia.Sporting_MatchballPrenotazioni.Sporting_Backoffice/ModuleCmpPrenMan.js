...
function setDotNetObjRef2(_dotNetObjRef) {
    //istanzio l'oggetto DotNetObjRef una sola volta in JS cosi' non devo passarlo ad ogni function
    myDotNetObjRef = _dotNetObjRef;
    //console.log("setDotNetObjRef2 ok");
}

var ArtmediaCmpPrenotazManSelMul = ArtmediaCmpPrenotazManSelMul || {}
...
ArtmediaCmpPrenotazManSelMul.Sporting_MatchballPrenotazioniBackoffice = {
...
$(document).ready(function () {
    console.log("ready Module CmpPrenotazManSelezioneMultipla");
});
