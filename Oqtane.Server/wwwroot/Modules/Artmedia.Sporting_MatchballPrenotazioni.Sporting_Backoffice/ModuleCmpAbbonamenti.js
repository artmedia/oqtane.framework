/* Module Script */
var ArtmediaCmpAbbonamenti = ArtmediaCmpAbbonamenti || {}
...
var myModalPeriodoInterruzioneAbbonamento;

ArtmediaCmpAbbonamenti.Sporting_MatchballPrenotazioniBackoffice = {
    ...
    OpenModalPeriodoInterruzioneAbbonamento: function () {
        myModalPeriodoInterruzioneAbbonamento = new bootstrap.Modal(document.getElementById('modalPeriodoInterruzioneAbbonamento'), {});
        myModalPeriodoInterruzioneAbbonamento.show();
        return true;
    },
    CloseModalPeriodoInterruzioneAbbonamento: function () {
        myModalPeriodoInterruzioneAbbonamento.hide();
        return true;
    }
...
$(document).ready(function () {
    console.log("ready Module CmpAbbonamenti");
});
