...
<xsl:stylesheet
  ...
  <link rel="stylesheet" href="https://www.iofatturo.it/DesktopModules/ArtmediaIOFatturo/css/bootstrap337CustomForXSLT.min.css">
    <xsl:value-of select="''"/>
  </link>
    
    <link rel="stylesheet" href="https://www.iofatturo.it/DesktopModules/ArtmediaIOFatturo/css/BootstrapV3/bootstrap-modal-bs3patch.css">
      <xsl:value-of select="''"/>
    </link>


    <link rel="stylesheet" href="https://www.iofatturo.it/DesktopModules/ArtmediaIOFatturo/css/BootstrapV3/bootstrap-modal.css">
      <xsl:value-of select="''"/>
    </link>
                  ...
                  <div class="panel-body">
                    ...
                    <xsl:for-each select="DatiPagamento">
                      <xsl:if test="CondizioniPagamento">
                        ...
                        Condizioni di pagamento:<xsl:text> </xsl:text>
                        <span>
