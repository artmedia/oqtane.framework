	...
	<xsl:template match="/">
		...
		<html lang="en">
			<head>
				...
				<style type="text/css">
					...
					*::after {
					...
					body {
					margin: 0;
					font-family: system-ui, -apple-system, "Segoe UI", Roboto, "Helvetica Neue", Arial, "Noto Sans", "Liberation Sans", sans-serif, "Apple Color Emoji", "Segoe UI Emoji", "Segoe UI Symbol", "Noto Color Emoji"; /*var(--bs-body-font-family);*/
					font-size: 1rem; /*var(--bs-body-font-size);*/
					font-weight: 400;/*var(--bs-body-font-weight);*/
					line-height: 1.5; /*var(--bs-body-line-height);*/
					color: #212529; /*var(--bs-body-color);*/
					text-align: var(--bs-body-text-align);
					background-color: #fff;/*var(--bs-body-bg);*/
					...
					h2, .h2 {
					font-size: 1.5rem; /*calc(1.325rem + 0.9vw);*/
					}
					@media (min-width: 1200px) {
					h2, .h2 {
					font-size: 2rem;
					...
					h3, .h3 {
					font-size: 1.75rem; /*calc(1.3rem + 0.6vw);*/
					}
					@media (min-width: 1200px) {
					h3, .h3 {
					font-size: 1.75rem;
					...
					h4, .h4 {
					font-size: 1.5rem; /* calc(1.275rem + 0.3vw);*/
					}
					@media (min-width: 1200px) {
					h4, .h4 {
					font-size: 1.5rem;
					...
					*/
					...
					margin-right: -.75rem; /* calc(-0.5 * var(--bs-gutter-x)); */
					margin-left:  -.75rem; /* calc(-0.5 * var(--bs-gutter-x)); */
					}
					.row > * {
					flex-shrink: 0;
					width: 100%;
					max-width: 100%;
					padding-right: .75rem; /*calc(var(--bs-gutter-x) * 0.5);*/
					padding-left: .75rem; /* calc(var(--bs-gutter-x) * 0.5);*/
					...
					.text-white {
					--bs-text-opacity: 1;
					color: white !important; /*rgba(var(--bs-white-rgb), var(--bs-text-opacity)) !important;*/
					}
					...
					.bg-primary {
					--bs-bg-opacity: 1;
					background-color: #0d6efd !important; /* rgba(var(--bs-primary-rgb), var(--bs-bg-opacity)) !important; */
					}
			...
			<body>
				...
				<div class="containerOLD" style="width:100%;padding-left: 1rem;padding-right: 1rem;">
									...
									<div class="row">
										<div class="col-6">
											...
											<xsl:if test="a:FatturaElettronica/FatturaElettronicaHeader/CedentePrestatore">
												...
												<div class="card border-primary">
													<div class="card-header bg-primary text-white">
														<h4 class="card-title">Fornitore (cedente/prestatore)</h4>
													</div>
													<div class="card-body">
                                ...
                                <xsl:if test="RegimeFiscale">
                                  ...
                                  <xsl:choose>
                                    ...
                                    <xsl:when test="$RF='RF03'">
                                      (nuove iniziative produttive) - Non piu' valido in quanto abrogato dalla legge di stabilita' 2015
                                    </xsl:when>
...
-->
                              ...
                              -->
														...
														<xsl:if test="a:FatturaElettronica/FatturaElettronicaHeader/CedentePrestatore/StabileOrganizzazione">
															<h5>Dati della stabile organizzazione</h5>
                            ...
                            <xsl:if test="a:FatturaElettronica/FatturaElettronicaHeader/CedentePrestatore/IscrizioneREA">
                              <h5>Dati di iscrizione nel registro delle imprese</h5>
...
-->
														...
														<xsl:if test="a:FatturaElettronica/FatturaElettronicaHeader/CedentePrestatore/RiferimentoAmministrazione">
															<!--<h5>Riferimento amministrativo</h5>-->
										...
										<div class="col-6">
											...
											<xsl:if test="a:FatturaElettronica/FatturaElettronicaHeader/CessionarioCommittente">
												<div class="card border-primary">
													...
													<div class="card-header bg-primary text-white">
														<h4 class="card-title">Cliente (cessionario/committente)</h4>
													</div>
													<div class="card-body">
                            ...
                            <xsl:if test="a:FatturaElettronica/FatturaElettronicaHeader/CessionarioCommittente/StabileOrganizzazione">
                              <h5>Stabile organizzazione del cessionario / committente</h5>
                            ...
                            <xsl:if test="a:FatturaElettronica/FatturaElettronicaHeader/CessionarioCommittente/RappresentanteFiscale">
                              <div id="rappresentante-fiscale">
                                <h5>Dati del rappresentante fiscale del cessionario / committente</h5>
  ...
  -->
						...
						<xsl:for-each select="a:FatturaElettronica/FatturaElettronicaBody">
							...
							<!--<div class="row"><div class="col-12"><h1>CodiceArticolo colspan=<xsl:value-of select="$existsColonnaCodice" />;</h1></div></div> -->
							...
							<xsl:if test="DatiBeniServizi">
								<div class="row mb-2">
									<div class="col-12">
										...
										<div class="card border-primary">
											<div class="card-header bg-primary text-white">
												<h4 class="card-title">Beni/Servizi</h4>
											</div>
											<div class="card-body">
																...
																<td>
																	<xsl:if test="Quantita">
																		<span>
																			...
																			<xsl:value-of select="format-number(translate(Quantita, ',','.'), '#.###,000########', 'd')"/>
																		</span>
																	</xsl:if>
																</td>
																...
																<td>
																	<xsl:if test="PrezzoUnitario">
																		<span>
																			...
																			<!--<xsl:value-of select='format-number(PrezzoUnitario, "#.000########")'/>-->
																			<xsl:value-of select="format-number(translate(PrezzoUnitario, ',','.'), '#.###,000########', 'd')"/>
																		</span>
																	</xsl:if>
																</td>
                                      ...
                                      <xsl:otherwise>7</xsl:otherwise>
											...
											<div class="card-footer">
												...
												<xsl:if test="DatiBeniServizi/DatiRiepilogo">
													...
													<!--<h5>Dati di riepilogo per aliquota IVA e natura</h5>-->
                  ...
                  or DatiVeicoli or Allegati">
													...
													<xsl:if test="DatiGenerali/DatiGeneraliDocumento">
														...
														<xsl:if test="DatiGenerali/DatiGeneraliDocumento/DatiCassaPrevidenziale">
															...
															<xsl:for-each select="DatiGenerali/DatiGeneraliDocumento/DatiCassaPrevidenziale">
																...
																<xsl:if test="Natura">
																	Tipologia di non imponibilita' del contributo:
																	<span>
																		<xsl:value-of select="Natura" />
																	</span>
														  ...
														  test="DatiGenerali/DatiTrasporto/MezzoTrasporto or DatiGenerali/DatiTrasporto/CausaleTrasporto or DatiGenerali/DatiTrasporto/NumeroColli or DatiGenerali/DatiTrasporto/Descrizione or DatiGenerali/DatiTrasporto/UnitaMisuraPeso or DatiGenerali/DatiTrasporto/PesoLordo or DatiGenerali/DatiTrasporto/PesoNetto or DatiGenerali/DatiTrasporto/DataOraRitiro or DatiGenerali/DatiTrasporto/DataInizioTrasporto or DatiGenerali/DatiTrasporto/TipoResa or DatiGenerali/DatiTrasporto/IndirizzoResa">
															...
															<xsl:for-each select="DatiGenerali/DatiTrasporto">
																...
																<xsl:if test="UnitaMisuraPeso">
																	Unita' di misura del peso merce:
																	<span>
                            ...
                            <span>nessun dato</span>
												...
												<xsl:if test="DatiVeicoli">
													<h5>Dati Veicoli ex art. 38 dl 331/1993</h5>
